                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div>Erik <strong>Flores</strong></div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Relizar compra</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Compra</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Proveedor</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Proveedor</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Producto</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Producto</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Categoria</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Categoria</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Relizar Venta</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Venta</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Cliente</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Cliente</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Empleados</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Empleados</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Agregar Cuenta</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Listar Cuenta</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html"><i class="icon fa fa-circle-o"></i> Generar Backup</a>
                            </li>
                            <li>
                                <a href="morris.html"><i class="icon fa fa-circle-o"></i> Restaurar Backup</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
